<template>
      ...
      <ion-content class="bg-orange">
        ...
        <form method="post" @submit.prevent="login">
          ...
          <ion-item class="transparent">
            <ion-checkbox v-model="login_form.accepted_terms"></ion-checkbox>
            <ion-label>J'accepte les <a href="/terms">CGU</a></ion-label>
          </ion-item>
          <br>
          <ion-button class="ion-margin" color="tertiary" type="submit" :disabled="!login_form.accepted_terms">Se connecter</ion-button>
  ...
  import { IonPage, IonInput, IonItem, IonLabel, IonButton, IonContent, IonCheckbox } from '@ionic/vue';
